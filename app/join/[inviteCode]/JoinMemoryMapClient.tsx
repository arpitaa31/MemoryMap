...
export default function JoinMemoryMapClient({ inviteCode }: { inviteCode: string }) {
  ...
  if (!authLoading && user?.isAnonymous) return <main className="mm-state-page"><h1>Guest sessions stay private</h1><p>Continue with Google to join shared campuses.</p><Link href="/dashboard" className="mm-button mm-button--coral">Back to dashboard</Link></main>;
